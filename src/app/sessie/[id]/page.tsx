 ...
 *
 * Er is bewust één weergave die met de fase meebeweegt in plaats van navigatie tussen tabbladen:
 * in een werksessie doet iedereen tegelijk hetzelfde, en wie zoekt naar het juiste scherm doet
 * niet mee aan het gesprek.
 */
  ...
  return (
    <>
      ...
      <main className="mx-auto w-full max-w-4xl flex-1 px-4 py-6">
        ...
        {state.sessie.fase === "lobby" ? <Lobby state={state} identiteit={identiteit} /> : null}
        {state.sessie.fase === "verkennen" ? (
          <Verkennen state={state} identiteit={identiteit} doe={doe} />
        ) : null}
        {state.sessie.fase === "identificatie" ? (
        ...
        {state.sessie.fase === "prioritering" ? (
          <Prioritering state={state} identiteit={identiteit} doe={doe} />
        ) : null}
        {state.sessie.fase === "roadmap" ? (
          <Roadmap state={state} identiteit={identiteit} doe={doe} />
        ) : null}
