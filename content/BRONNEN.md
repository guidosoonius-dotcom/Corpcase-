...
| CORA-bedrijfsfuncties | 61 functies in `content/processen/cora-bedrijfsfuncties.json` | Twee platen van het sturende en primaire functiemodel, aangeleverd door de opdrachtgever | Controleer de benamingen tegen coraveraonline.nl. Let op drie dingen: de platen zijn **bijgesneden schermafdrukken** (plaat 1 bovenaan afgekapt, plaat 2 loopt rechts buiten beeld), er ontbreekt een plaat met de **ondersteunende** functies, en "Leveren services door derden" is in de plaat afwijkend gekleurd — wat dat in het bronmodel betekent is nog onbekend |
